...
function(commander_initialize_workspace)
    ...
    add_custom_target(${TARGET_NAME}
        COMMAND cp -R ${PARSED_ARGS_WORKSPACE_TEMPLATE} ${PARSED_ARGS_WORKSPACE_OUTPUT_PATH}
        COMMAND yaml-merge  ${PARSED_ARGS_XTCE_CONFIG_FILE} ${PARSED_ARGS_CONFIG_FILE} --overwrite ${PARSED_ARGS_CONFIG_FILE}
        COMMAND cp -R ${PARSED_ARGS_CONFIG_FILE} ${PARSED_ARGS_WORKSPACE_OUTPUT_PATH}/definitions.yaml
